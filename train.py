...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov5s.pt', help='initial weights path')#权重参数
    parser.add_argument('--cfg', type=str, default=r'configs\yolov5-standard\yolov5s.yaml', help='model.yaml path')#网络参数配置参数，在config文件里，任意一个yaml文件进行替换即可
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')#数据配置参数,在data文件里，任意一个yaml文件进行替换即可
    #以下一行为超参数配置，默认为hyp.scratch-low.yaml
